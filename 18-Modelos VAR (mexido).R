...
br <- subset(pwt8.0, country=="Brazil", 
             select = c("rgdpna","emp","xr"))  #Cria a tabela "br" com dados das linhas que assumem o valor "country" (país) igual a "Brazil", selecionando as colunas cujas variáveis são "rgdpna" (PIB), "avh" (TRABALHO)  e "xr" (CAMBIO)
...
h3 = hchart(Cambio, name = "Câmbio", color = "green")
  hc_title(h3,text = "Variação do Câmbio (R$/US$)", margin = 10, style = list(fontSize= "14px")) #Gráfico do Câmbio

lst = list(h1,h2,h3)
hw_grid(lst, ncol = 2, rowheight = 400)  %>% browsable()  #Todos os Três Gráficos Juntos
